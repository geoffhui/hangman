...
let description_of_words = {"Committee": "a person or group of persons appointed to perform some service or function, as to investigate, report, or act upon a particular matter.",
                     "Tattoo": "A form of body modification where a design is made by inserting ink",
                     "Electricity": "Is the set of physical phenomena associated with the presence and motion of electric charge",
                     "pneumonoultramicroscopicsilicovolcanoconiosis": "an obscure term ostensibly referring to a lung disease caused by silica dust.",
                     "Pseudopseudohypoparathyroidism": "An inherited disorder that closely simulates the symptoms but not the consequences of pseudohypoparathyroidism.",
